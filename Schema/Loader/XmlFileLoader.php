...
use Alms\Bundle\CycleBundle\Schema\Generator\EntityCollection;
use Alms\Bundle\CycleBundle\Schema\GeneratorCollection;
use Alms\Bundle\CycleBundle\Schema\SchemaModifier\RegisterIndexes;
use Alms\Bundle\CycleBundle\Schema\Table;
